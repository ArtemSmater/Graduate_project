...
public class HardPlayGame extends AppCompatActivity {
    ...
    private void checkPlayer(ImageView image) {
        ...
        if (!Arrays.toString(boxPositions).contains("0") && !checkResult()) {
            ResultDialog dialog = new ResultDialog(HardPlayGame.this,
                    "Draw!", HardPlayGame.this);
    ...
    private void endGame() {
        if (activePlayer == 1) {
            ResultDialog dialog = new ResultDialog(HardPlayGame.this,
                    secondName.getText().toString() + " is a winner!", HardPlayGame.this);
            dialog.setCancelable(false);
            dialog.show();
            scoreX++;
            secondScore.setText(String.format(Locale.getDefault(), "%d", scoreX));
            ...
            ResultDialog dialog = new ResultDialog(HardPlayGame.this,
                    firstName.getText().toString() + " is a winner!", HardPlayGame.this);
            dialog.setCancelable(false);
            dialog.show();
            scoreO++;
            firstScore.setText(String.format(Locale.getDefault(), "%d", scoreO));
