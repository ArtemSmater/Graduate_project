...
public class SixthLevel extends AppCompatActivity {
    ...
    private final String[] colorsTxt = {
            "aqua", "black", "blue",
            "brown", "gray", "green",
            "indigo", "ivory color", "khaki",
            "light blue", "olive", "orange",
            "pink", "purple", "red",
            "vinous", "violet", "white",
            "yellow"};

    private final int[] colorsImg = {
            R.drawable.aqua, R.drawable.black, R.drawable.blue,
            R.drawable.brown, R.drawable.gray, R.drawable.green,
            R.drawable.indigo, R.drawable.ivory_color, R.drawable.khaki,
            R.drawable.light_blue, R.drawable.olive, R.drawable.orange_c,
            R.drawable.pink, R.drawable.purple, R.drawable.red,
            R.drawable.vinous, R.drawable.violet, R.drawable.white,
            R.drawable.yellow};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getString(R.string.colors));
        ...
        ivPrev.setImageResource(R.drawable.colors_prev);
        TextView tvPrev = prevDialog.findViewById(R.id.tvPreview);
        tvPrev.setText(R.string.colors_prev);
        ...
        tvEnd.setText(R.string.colors_end);
        // set listeners to buttons
        ...
        endDialog.findViewById(R.id.btnRight).setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), SeventhLevel.class);
    ...
    private void createQuestion() {
        ...
        ivTask.setImageResource(colorsImg[rightAns]);
        ivTask.startAnimation(animAlpha);

        // set text to buttons
        for (int i = 0, j = 0; i < buttons.length; i++) {
            if (i == rightPos) {
                buttons[i].setText(colorsTxt[rightAns]);
                buttons[i].startAnimation(animAlpha);
            } else {
                buttons[i].setText(colorsTxt[wrongPositions.get(j)]);
                buttons[i].startAnimation(animAlpha);
                j++;
            }
        }
    ...
    public void onClickAnswer(View view) {
        ...
        if (tag == rightPos) {
            ...
            Toast.makeText(getApplicationContext(), "Wrong answer!\nRight answer is " +
                    colorsTxt[rightAns], Toast.LENGTH_SHORT).show();
        }
        tvPoints.setText(String.format(Locale.getDefault(), "%d points", points));
        checkWon();
        createQuestion();
