 ...
 * Use the {@link SecondFrame#newInstance} factory method to
...
public class SecondFrame extends Fragment {
    ...
    public static SecondFrame newInstance(String param1, String param2) {
        SecondFrame fragment = new SecondFrame();
